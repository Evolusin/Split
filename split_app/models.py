...
class Obligation(models.Model):
    ...
    optional_value = models.DecimalField(max_digits=6, decimal_places=2, null=True, blank=True)
    o_status = models.CharField(default=c.new, choices=c.status, max_length=16)
    payment_date = models.DateField(default=django.utils.timezone.now, null=True, blank=True)
    def __str__(self):
